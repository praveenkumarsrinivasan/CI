require(
    [
        ...
        'text',
        'text!header.html',
        'text!templates/exp/prt_title.html',
        'text!templates/exp/memory_title.html',
        'text!templates/exp/meta_title.html',
        'text!templates/exp/test_title.html',
        'text!templates/exp/priming_title.html',
        'text!templates/exp/prt_welcome.html',
        'text!templates/exp/prt_intro_instruction.html',
        'text!templates/exp/memory_instruction1.html',
        'text!templates/exp/memory_instruction2.html',
        'text!templates/exp/memory_bird.html',
        'text!templates/exp/memory_images.html',
        'text!templates/exp/metacognition_instruction.html',
        'text!templates/exp/testing_bird.html',
        'text!templates/exp/testing_bird_large.html',
        'text!templates/exp/testing_images.html',
        'text!templates/exp/response_time.html',
        'text!templates/exp/star.html',
        'text!templates/exp/star_cloud.html',
        'text!templates/exp/cloud.html',
        'text!templates/exp/dot.html',
        'text!templates/exp/correct.html',
        'text!templates/exp/incorrect.html',
        'text!templates/exp/maybe.html',
        'text!templates/exp/exp_fail.html',
        'text!templates/exp/exp_complete.html',
    ],
    function(
